...
public final class Constants {
    ...
    public static final int AWARDS_NUMBER = 3;
    ...
    public static final String FILTERDESCRIPTION = "filter_description";
    public static final String LONGEST = "longest";
    public static final String MOSTVIEWD = "most_viewed";
    public static final String STANDARD = "standard";
    public static final String BESTUNSEEN = "best_unseen";
    public static final String POPULAR = "popular";
    public static final String SEARCH = "search";
    public static final String NIMIC = "nimic";
    public static final String BASIC = "BASIC";
    public static final String ACTIONADVENTURE = "Action & Adventure";
    public static final String ANIMATION = "Animation";
    public static final String SCIFI = "Sci-Fi & Fantasy";
